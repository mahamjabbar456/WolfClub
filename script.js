...
var BlurElement = document.querySelector(".cursor-blur");
document.addEventListener("mousemove",function(dets){
    cursorElement.style.left = dets.x +"px";
    cursorElement.style.top = dets.y +"px";
    BlurElement.style.left = dets.x - 250 +"px";
    BlurElement.style.top = dets.y - 250+"px";
})
